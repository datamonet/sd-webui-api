 ...
 */
function toBase64(image, raw) {
    if (raw === void 0) { raw = false; }
    return __awaiter(this, void 0, void 0, function () {
        var header, result, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    header = "data:image/png;base64,";
                    if (!raw) return [3 /*break*/, 2];
                    return [4 /*yield*/, image.raw().toBuffer()];
                case 1:
                    _a = (_c.sent()).toString("base64");
                    return [3 /*break*/, 4];
                case 2:
                    _b = header;
                    return [4 /*yield*/, image.png().toBuffer()];
                case 3:
                    _a = _b + (_c.sent()).toString("base64");
                    _c.label = 4;
                case 4:
                    result = _a;
